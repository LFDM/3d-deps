...
export const CONFIG: Config = {
  ...
  hotkeys: {
    ...
    "hud.search": ["/", "f"],
    "hud.toggleHotkeyInfo": ["?"],
    "graph.dependencies.maxDepth.increase": ["alt+j", "alt+up"],
    "graph.dependencies.maxDepth.decrease": ["alt+k", "alt+down"],
    "graph.dependents.maxDepth.increase": ["alt+shift+k", "alt+shift+down"],
    "graph.dependents.maxDepth.decrease": ["alt+shift+k", "alt+shift+down"],
